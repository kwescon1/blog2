                                ...
                                <tbody>
                                    ...
                                    @foreach ($categories as $category)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('back-categories.edit', $category->id) }}"
                                                ...
                                                <a href="{{ route('softDelete.back-category', $category->id) }}"
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form @if (session('data'))
                                ...
                                action = "{{ route('back-categories.update', session('data')['data']->id) }}"
                                method ="POST"

                            @else action = "{{ route('back-categories.store') }}" method ="POST" @endif
                                >
                                ...
                                <tbody>
                                    ...
                                    @foreach ($trashedCategories as $category)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <a href="{{ route('restore.back-category', $category->id) }}"
                                                        class="btn btn-info"><i class="fa fa-window-restore"
                                                            aria-hidden="true"></i></a>
                                                    <form action="{{ route('back-categories.destroy', $category->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        {{ method_field('DELETE') }}
